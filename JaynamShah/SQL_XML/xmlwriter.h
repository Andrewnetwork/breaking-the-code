...
public:
	...
	inline XmlStream(ostream&	_s) : s(_s), state(stateNone), prologWritten(false) {}
...
private:
	...
	// tag name stack
	typedef stack<string>	tag_stack_type;
